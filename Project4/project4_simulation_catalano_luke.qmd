...
-   Review how new random data should be generated

# Estimates

-   Review what the output of the experiment should be (# of clusters? )
...
-   Review what the performance output of the experiment should be.
